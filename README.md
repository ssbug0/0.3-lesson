...
Изменяя payload блока изменяется его хеш и хеш всей последующей цепочки блоков по причине того, что каждый последующий блока содержит хеш(поле prev) предыдущего.
...
| Скорость транзакций | Механизм консенсуса PoS и DPoS обеспечивают наиболее высокие скорости транзакций (TPS) в отличии от PoW по причине отсутствия необходимости выполнения оборудованием ресурсоемких операций.Блокчейны построенные на PoW консенсусе как правило ограничены 100-1000 TPS, когда PoS и DPoS могут предложить от 100 тыс. до 1 млн TPS в зависимости от масштабирования сети.|
| Безопасность | PoW традиционно считается высокозащищённым тк обеспечивает гарантии неизменности истории, дороговизной атак (необходимость контроля большей доли хешрейта сети). PoS более подвержен long-range и finality атакам, но это компенсируется финансовой ответственностью валидаторов, высокими рисками финансовых потерь. DPoS консенсус наиболее уязвим к атакам, основанных на сговоре делегатов, но при этом, в случае выбора доверенных, надежных делегатов может обеспечить наибольшую безопаность сети. Так же он защищен от изменения истории в сети, тк она контролируется ограниченным числом доверенных делегатов.|
