...
Произведен общий анализ и сопоставления популярных механизмов консенсуса по скорости обработки транзакций, безопасности и требованиям к оборудованию. Изучены основные типы уязвимостей блокчейнов(long-range, Sybil, nothing at stake, 51%).
